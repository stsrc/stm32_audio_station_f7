...
#define EXTERNAL_CLOCK_VALUE                                                   \
  12288000U /*!< Value of the Internal oscillator in Hz*/
...
#define ETH_RX_BUF_SIZE                                                        \
  1524U /* ETH Max buffer size for receive               */
#define ETH_TX_BUF_SIZE                                                        \
  1524U                /* ETH Max buffer size for transmit              */
...
#define PHY_SR                                                                 \
  ((uint16_t)0x001FU) /*!< PHY special control/ status register Offset     */
